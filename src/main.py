...
train_images, train_labels = read_hoda_cdb('../dataset/Train 60000.cdb')
...
test_images, test_labels = read_hoda_cdb('../dataset/Test 20000.cdb')
...
remaining_images, remaining_labels = read_hoda_cdb('../dataset/RemainingSamples.cdb')
